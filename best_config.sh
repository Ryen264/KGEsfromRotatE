...
# Dataset folder names must match data/ (fb15k, fb15k_237, countries_s1, ...)
#
...
# bash run.sh train ComplEx fb15k_237 0 0 1024 256 1000 200.0 1.0 0.001 100000 16 -de -dr -r 0.00001 -rp 3
bash run.sh train ComplEx fb15k_237 0 0 1024 256 1000 200.0 1.0 0.001 188 16 -de -dr -r 0.00001 -rp 3
