#!/bin/sh
# Start visualization/main.py training in the background with nohup.
#
# Usage:
#   ./nohup/run_main.sh configs/ComplEx_WN18RR_ce.json
#   ./nohup/run_main.sh configs/ComplEx_WN18RR_ce.json --gpu 0 --display-epochs 100 --no-show
#
